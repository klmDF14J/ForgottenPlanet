package com.roboyobo.forgottenPlanet.mob.model;
...
public class ModelEmblazonedCreeper extends ModelBase
{
  //fields
  ...
  public ModelEmblazonedCreeper() {
	  this(0.0F);
  }
  
  public ModelEmblazonedCreeper(float par1)
  {
    textureWidth = 64;
    textureHeight = 32;

...
public class EntityEmblazonedHuman extends EntityMob
{
    /**
    ...
    public EntityEmblazonedHuman(World par1World)
    {
        super(par1World);
    ...
    public void onKillEntity(EntityLiving par1EntityLiving)
    {
        ...
        if (this.worldObj.difficultySetting >= 2 && par1EntityLiving instanceof EntityVillager)
        {
            ...
            EntityEmblazonedHuman entityzombie = new EntityEmblazonedHuman(this.worldObj);

...
public class Mobs {
	...
	public static void initMobs() {
		addMob(EntityEmblazonedCreeper.class, "Emblazoned Creeper", nextID, Mod, 80, 3, true, EntityEmblazonedCreeper.class, 10, 2, 4, EnumCreatureType.monster, ForgottenPlanet.modid, new RenderEmblazonedCreeper(new ModelEmblazonedCreeper(), 2.0F), ForgottenPlanet.emblazonedForest);
		addMob(EntityEmblazonedHuman.class, "Emblazoned Human", nextID, Mod, 80, 3, true, EntityEmblazonedHuman.class, 10, 2, 4, EnumCreatureType.monster, ForgottenPlanet.modid, new RenderEmblazonedHuman(new ModelEmblazonedHuman(), 2.0F), ForgottenPlanet.emblazonedForest);
	}
	
	private static void addMob(Class<? extends Entity> entity, String name, int id, Object mod, int trackingRange, int updateRange, boolean sendVeloPackets, Class<? extends EntityLiving> entityLiving, int weightedProb, int min, int max, EnumCreatureType type, String modid, Render render, BiomeGenBase... biomes) {

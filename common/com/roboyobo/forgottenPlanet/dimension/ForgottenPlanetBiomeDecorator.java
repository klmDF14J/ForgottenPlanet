...
public class ForgottenPlanetBiomeDecorator extends BiomeDecorator
{    

    private float shrubChance;

	public ForgottenPlanetBiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
    	super(par1BiomeGenBase);
        this.sandGen = new WorldGenSand(7, Blocks.forgottenSand.blockID);
    ...
    protected void decorate()
    {
       ...
       this.generateOres();
        ...
        if(randomGenerator.nextFloat() < shrubChance)
        {
            ...
            i1 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
            time = System.nanoTime();
            (new WorldGenShrub(Block.tallGrass.blockID, 8)).generate(this.currentWorld, this.randomGenerator, k, l, i1);

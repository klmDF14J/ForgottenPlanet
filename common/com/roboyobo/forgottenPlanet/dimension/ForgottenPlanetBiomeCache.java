...
public class ForgottenPlanetBiomeCache extends BiomeCache
{
    /** Reference to the WorldChunkManager */
    private final ForgottenPlanetChunkManager chunkManager;
    ...
    public ForgottenPlanetBiomeCache(ForgottenPlanetChunkManager par1WorldChunkManager)
    {
     ...
     */
    static WorldChunkManager getChunkManager(ForgottenPlanetBiomeCache par0BiomeCache)
    {

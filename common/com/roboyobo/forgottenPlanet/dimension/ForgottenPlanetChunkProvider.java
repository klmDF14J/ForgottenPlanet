...
public class ForgottenPlanetChunkProvider implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ForgottenPlanetChunkProvider(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)ForgottenPlanet.stoneGen;
                                }
                                else if (var12 * 8 + var31 < var6)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)Blocks.forgottenGrass.blockID;
                                }
                                else
                                {
            ...
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = 127; var16 >= 0; --var16)
                {
                    ...
                    else
                    {
                        ...
                        else if (var18 == ForgottenPlanet.stoneGen)
                        {
                            if (var13 == -1)
                            {
                                if (var12 <= 0)
                                {
                                    var14 = 0;
                                    var15 = (byte)ForgottenPlanet.stoneGen;
                                }
    ...
    private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        //this.noise6 = this.noiseGen6.generateNoiseOctaves(this.noise6, par2, par4, par5, par7, 400.0D, 400.0D, 0.5D);
        this.noise3 = this.noiseGen3.generateNoiseOctaves(this.noise3, par2, par3, par4, par5, par6, par7, var44 / 1000000.0D, var45 / 2000000.0D, var44 / 1000000.0D);
        //this.noise3 = this.noiseGen3.generateNoiseOctaves(this.noise3, par2, par3, par4, par5, par6, par7, var44 / 69.0D, var45 / 69.0D, var44 / 69.0D);
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
                ...
                !var11 && this.rand.nextInt(4) == 0)
        {
            ...
            (new ForgottenPlanetEnchantedGrassPatch(Blocks.emblazonedGrass.blockID)).generate(this.worldObj, this.rand, var12, var13, var14);
        }

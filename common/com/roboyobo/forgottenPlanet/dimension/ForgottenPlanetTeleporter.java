...
public class ForgottenPlanetTeleporter extends Teleporter
{
 ...
 private final List field_85190_d = new ArrayList();
  ...
  public ForgottenPlanetTeleporter(WorldServer par1WorldServer)
 {
 ...
 public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
 {
  ...
  else
  {
   for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
   {
     ...
     for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
    {
     ...
     {
      if (this.field_85192_a.getBlockId(var48, var26, var23) == Blocks.portal.blockID)
      {
       while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == Blocks.portal.blockID)
       {
        --var26;
       }
   ...
   if (var10 >= 0.0D)
  {
   ...
   int var50 = -1;
    ...
    if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Blocks.portal.blockID)
   {
    var50 = 2;
   }
    ...
    if (this.field_85192_a.getBlockId(var12 + 1, var13, var14) == Blocks.portal.blockID)
   {
    ...
    if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == Blocks.portal.blockID)
   {
    var50 = 3;
   }

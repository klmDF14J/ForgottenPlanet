...
public class ForgottenPlanetChunkManager extends WorldChunkManager
{
    ...
    public ForgottenPlanetChunkManager(BiomeGenBase par1BiomeGenBase, float par2, float par3)
    {

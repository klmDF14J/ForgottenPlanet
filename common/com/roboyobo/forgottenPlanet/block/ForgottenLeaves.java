...
public class ForgottenLeaves extends Block implements IShearable
{
    ...
    protected ForgottenLeaves(int par1)
    {
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Items.forgottenApple, 1, 0));
            }
        }
    }

...
public class ToxifiedGrass extends Block
{
	...
	int numOfTimesRun = 0;
       ...
       public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
    	   ...
    	   if(rand == 1) {
    		   ParticleSpawner.spawnRandomParticle(par5Random, par1World, "reddust", par2, par3, par4, 0, 255, 0);
    		   ParticleSpawner.spawnRandomParticle(par5Random, par1World, "happyVillager", par2, par3, par4, 0, 255, 0);
    	   }
       }

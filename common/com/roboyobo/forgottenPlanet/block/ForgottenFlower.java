...
public class ForgottenFlower extends Block implements IPlantable
{
    protected ForgottenFlower(int par1, Material par2Material)
    {
    ...
    protected ForgottenFlower(int par1)
    {
    ...
    {
        return par1 == Blocks.forgottenGrass.blockID || par1 == Blocks.forgottenDirt.blockID;
    }
